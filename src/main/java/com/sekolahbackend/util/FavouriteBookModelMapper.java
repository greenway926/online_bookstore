...
public class FavouriteBookModelMapper {
    ...
    public static FavouriteBookModel constructModel(FavouriteBook favouriteBook) {
        ...
        favouriteBook.getFavouriteBookDetails().forEach(data -> {
            FavouriteBookModel.DetailModel detail = new DetailModel();
    ...
    public static List<FavouriteBookModel> constructModel(List<FavouriteBook> favouriteBooks) {
    ...
    public static FavouriteBookModel construcModelForRequest(FavouriteBookRequestModel request) {
        FavouriteBookModel favouriteBookModel = new FavouriteBookModel();
        FavouriteBookModel.DetailModel detail = getFavouriteDetailModel(request.getBookId());
    ...
    private static FavouriteBookModel.DetailModel getFavouriteDetailModel(Integer bookId) {
